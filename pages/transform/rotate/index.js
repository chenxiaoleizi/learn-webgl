...
const rotateLocation = gl.getUniformLocation(program, "u_matrix")
...
function draw() {
  ...
  gl.uniformMatrix4fv(rotateLocation, false, modelMatrix.elements)
...
// rotate.add(settings, "rotateX").min(0).max(360).step(1)
// rotate.add(settings, "rotateY").min(0).max(360).step(1)
rotate.add(settings, "rotateZ").min(0).max(360).step(1)
